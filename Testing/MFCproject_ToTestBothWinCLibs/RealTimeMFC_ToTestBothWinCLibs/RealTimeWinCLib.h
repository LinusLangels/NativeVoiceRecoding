#pragma once
#ifndef _DLL_RTWIN_H_
#define _DLL_RTWIN_H_
...
extern "C"
{
	...
	DECLDIR2 void MicInit();
	DECLDIR2 char* MicStart(bool lowCompelxityOFF, char *directorySavePath, char* guid);
	DECLDIR2 bool MicStop();
